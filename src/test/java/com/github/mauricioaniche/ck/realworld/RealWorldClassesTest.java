...
public class RealWorldClassesTest extends BaseTest {
	...
	public void commonsCsvClass2() {
		...
		Assertions.assertEquals(627, ck.getMethod("isLineBreak/1[char]").get().getStartLine());

		Assertions.assertEquals(1567, ck.getMethod("withAllowMissingColumnNames/1[boolean]").get().getStartLine());
	}
